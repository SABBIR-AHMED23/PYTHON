...
plt.plot(S_range,bull,label='Bull')
plt.plot(S_range,bear,label='Bear')
plt.plot(S_range,butterfly_c,label='Butterfly call')
plt.plot(S_range,butterfly_p,label='Butterfly put')
plt.plot(S_range,straddle_profit,label='Straddle')
plt.plot(S_range,strangle_profit,label='Strangle')
plt.legend()
plt.grid()
plt.show()